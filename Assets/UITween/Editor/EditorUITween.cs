...
public class EditorUITween : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (tweenScript != null)
        {
            if (tweenScript.rectTransform)
            {
                ...
                {
                    tweenScript.animationParts.SetAniamtioDuration(EditorGUILayout.Slider("Animation Duration (Sec)",
                        tweenScript.animationParts.GetAnimationDuration(), 0.01f, 10f));
                ...
                {
                    if (GUILayout.Button("Animate")) tweenScript.OpenCloseObjectAnimation();
            ...
            else
            {
                EditorGUILayout.HelpBox(
                    "Please set \"Rect Trasnform Variable\" that contains \"RectTransform\" component. UI Components",
                    MessageType.Info);
            }
        }
    ...
    private void GetButtonPos()
    {
        ...
        if (positionEnabled || rotationEnabled || scaleEnabled)
        {
            if (GUILayout.Button("Get Start Values")) GetStartValues();

            if (GUILayout.Button("Get End Values")) GetEndValues();
        }
        ...
        if (positionEnabled || rotationEnabled || scaleEnabled ||
            tweenScript.animationParts.FadePropetiesAnim.IsFadeEnabled())
        {
            if (GUILayout.Button("Set To Start Values")) SetStartValues();

            if (GUILayout.Button("Set To End Values")) SetEndValues();
        }
    ...
    {
        var selectedTransform = tweenScript.rectTransform;

        tweenScript.animationParts.PositionPropetiesAnim.SetPosStart((Vector3) selectedTransform.anchoredPosition,
            selectedTransform);
    ...
    private void GetEndValues()
    {
        ...
        tweenScript.animationParts.PositionPropetiesAnim.SetPosEnd((Vector3) selectedTransform.anchoredPosition,
    ...
    private void SetStartValues()
    {
        ...
        if (tweenScript.animationParts.FadePropetiesAnim.IsFadeEnabled())
        {
            if (tweenScript.IsObjectOpened())
                SetAlphaValue(selectedTransform.transform,
                    tweenScript.animationParts.FadePropetiesAnim.GetEndFadeValue());
            else
                SetAlphaValue(selectedTransform.transform,
                    tweenScript.animationParts.FadePropetiesAnim.GetStartFadeValue());
        }
    }
    ...
    private void SetAlphaValue(Transform _objectToSetAlpha, float alphaValue)
    {
    ...
    private void EditorFade()
    {
        ...
        if (tweenScript.animationParts.FadePropetiesAnim.IsFadeEnabled())
        {
            ...
            var fadeValueStart = EditorGUILayout.FloatField("Start Value",
                tweenScript.animationParts.FadePropetiesAnim.GetStartFadeValue());
            var fadeValueEnd = EditorGUILayout.FloatField("End Value",
                tweenScript.animationParts.FadePropetiesAnim.GetEndFadeValue());
            ...
            tweenScript.animationParts.FadePropetiesAnim.SetFadeOverride(EditorGUILayout.BeginToggleGroup(
                "Fade Override",
                tweenScript.animationParts.FadePropetiesAnim.IsFadeOverrideEnabled()));
    ...
    private void EditorPos()
    {
        tweenScript.animationParts.PositionPropetiesAnim.SetPositionEnable(EditorGUILayout.BeginToggleGroup(
            "Position Animation",
        ...
        if (positionEnabled)
        {
            tweenScript.animationParts.PositionPropetiesAnim.SetPosStart(
                EditorGUILayout.Vector3Field("Start Move", tweenScript.animationParts.PositionPropetiesAnim.StartPos),
                tweenScript.rectTransform);
            tweenScript.animationParts.PositionPropetiesAnim.SetPosEnd(
                EditorGUILayout.Vector3Field("End Move", tweenScript.animationParts.PositionPropetiesAnim.EndPos),
                tweenScript.rectTransform.transform);
            ...
            tweenScript.animationParts.PositionPropetiesAnim.TweenCurveEnterPos = EditorGUILayout.CurveField(
                "Start Tween Move",
                tweenScript.animationParts.PositionPropetiesAnim.TweenCurveEnterPos);
            EditorGUILayout.Space();
            tweenScript.animationParts.PositionPropetiesAnim.TweenCurveExitPos = EditorGUILayout.CurveField(
                "Exit Tween Move",
    ...
    private void EditorScale()
    {
        ...
        if (scaleEnabled)
        {
            tweenScript.animationParts.ScalePropetiesAnim.StartScale = EditorGUILayout.Vector3Field("Start Scale",
                tweenScript.animationParts.ScalePropetiesAnim.StartScale);
            tweenScript.animationParts.ScalePropetiesAnim.EndScale = EditorGUILayout.Vector3Field("End Scale",
                tweenScript.animationParts.ScalePropetiesAnim.EndScale);
            ...
            tweenScript.animationParts.ScalePropetiesAnim.TweenCurveEnterScale = EditorGUILayout.CurveField(
                "Start Tween Scale",
                tweenScript.animationParts.ScalePropetiesAnim.TweenCurveEnterScale);
            EditorGUILayout.Space();
            tweenScript.animationParts.ScalePropetiesAnim.TweenCurveExitScale = EditorGUILayout.CurveField(
                "Exit Tween Scale",
    ...
    private void EditorRot()
    {
        tweenScript.animationParts.RotationPropetiesAnim.SetRotationEnable(EditorGUILayout.BeginToggleGroup(
            "Rotation Animation",
        ...
        if (rotationEnabled)
        {
            tweenScript.animationParts.RotationPropetiesAnim.StartRot = EditorGUILayout.Vector3Field("Start Rotation",
                tweenScript.animationParts.RotationPropetiesAnim.StartRot);
            tweenScript.animationParts.RotationPropetiesAnim.EndRot = EditorGUILayout.Vector3Field("End Rotation",
                tweenScript.animationParts.RotationPropetiesAnim.EndRot);
            ...
            tweenScript.animationParts.RotationPropetiesAnim.TweenCurveEnterRot = EditorGUILayout.CurveField(
                "Start Tween Rotation",
                tweenScript.animationParts.RotationPropetiesAnim.TweenCurveEnterRot);
            EditorGUILayout.Space();
            tweenScript.animationParts.RotationPropetiesAnim.TweenCurveExitRot = EditorGUILayout.CurveField(
                "Exit Tween Rotation",
